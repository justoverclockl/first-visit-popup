    ...
    return(
      <div className="first-visit-popup-container">
        <div className="fvp-form">
          ...
          <input className="FormControl fvp" type="text" id="fvp-title" placeholder="My Modal" name="fvp-title"
        ...
        <div className="fvp-textarea">
          ...
          <textarea className="FormControl fvptextarea" id="fvp-content" placeholder="<style></style><div></div>" name="fvp-title"
